...
namespace TeacherManager.CustomControls
{
    public partial class CustomDateTimePicker : DateTimePicker
    {
        ...
        private Image calendarIcon = TeacherManager.Properties.Resources.calendarWhite;
        ...
        public Color SkinColor
        {
            ...
            set
            {
                ...
                if (skinColor.GetBrightness() >= 0.8F)
                    calendarIcon = TeacherManager.Properties.Resources.calendarDark;
                else calendarIcon = TeacherManager.Properties.Resources.calendarWhite;
                this.Invalidate();
            }
        }
